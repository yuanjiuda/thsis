...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{1.9cm}p{1.6cm}p{2.1cm}p{1.7cm}p{1.4cm}p{1.4cm}p{1.8cm}p{1.9cm}}
        ...
        \midrule
        OFDM & 直接检测/相干接收 & 傅里叶正交子载波、循环前缀 & 准静态或低动态多径环境 & 中等 & 较弱 & 频谱效率较高，但对前缀和同步敏感 & 高动态下 ICI 明显，深衰落位置敏感 \\
        ACO-OFDM / DCO-OFDM / U-OFDM & IM-DD & 面向非负实信号约束的单极性扩展 & 低动态 IM-DD 光链路 & 中等 & 较弱 & ACO 功率效率高，DCO 频谱效率较高 & 仍依赖傅里叶域结构，对多径和多普勒适应性有限 \\
        AFDM & 以复数域接收为主 & 基于 DAFT 的啁啾多载波映射 & 时延--多普勒耦合信道 & 较强 & 较强 & 在结构可调性和分集利用方面更灵活 & 参数设计和检测复杂度高于传统 OFDM \\
